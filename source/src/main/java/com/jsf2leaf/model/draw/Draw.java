...
public class Draw {
	...
	public void create(AjaxBehaviorEvent event) {
		...
		if (jsonObj.getJSONObject("properties").get("type").equals("marker")) {
			...
			jsonObj.getJSONObject("properties").put("index", layer.getMarkers().indexOf(marker));
			geoJsonObject = jsonObj.toString();
		} else if (jsonObj.getJSONObject("properties").get("type").equals("circle")) {
			String latitude = jsonObj.getJSONObject("geometry").getJSONArray("coordinates").get(1).toString(); 
			String longitude = jsonObj.getJSONObject("geometry").getJSONArray("coordinates").get(0).toString();
			...
			jsonObj.getJSONObject("properties").put("index", layer.getCircles().indexOf(circle));
			geoJsonObject = jsonObj.toString();
		} else if (jsonObj.getJSONObject("properties").get("type").equals("polyline")) {
			...
			jsonObj.getJSONObject("properties").put("index", layer.getPolylines().indexOf(polyline));
			geoJsonObject = jsonObj.toString();
		} else if (jsonObj.getJSONObject("properties").get("type").equals("polygon") || jsonObj.getJSONObject("properties").get("type").equals("rectangle")) {
			Feature feature = new Feature();
			feature.setGeometry(jsonObj.getJSONObject("geometry").toString());
			layer.addFeature(feature);
			jsonObj.getJSONObject("properties").put("index", layer.getFeatures().indexOf(feature));
			geoJsonObject = jsonObj.toString();
		}
	}
	...
	public void edit(AjaxBehaviorEvent event) {
		JSONObject jsonObj = new JSONObject(geoJsonObject);
		if (jsonObj.getJSONObject("properties").getInt("index") >= 0) {
			if (jsonObj.getJSONObject("properties").get("type").equals("marker") && jsonObj.getJSONObject("properties").getInt("index") < layer.getMarkers().size()) {
				String latitude = jsonObj.getJSONObject("geometry").getJSONArray("coordinates").get(1).toString(); 
				String longitude = jsonObj.getJSONObject("geometry").getJSONArray("coordinates").get(0).toString();
				layer.getMarkers().get(jsonObj.getJSONObject("properties").getInt("index")).setPosition(new LatLong(latitude, longitude));
			} else if (jsonObj.getJSONObject("properties").get("type").equals("circle") && jsonObj.getJSONObject("properties").getInt("index") < layer.getCircles().size()) {
				String latitude = jsonObj.getJSONObject("geometry").getJSONArray("coordinates").get(1).toString(); 
				String longitude = jsonObj.getJSONObject("geometry").getJSONArray("coordinates").get(0).toString();
				layer.getCircles().get(jsonObj.getJSONObject("properties").getInt("index")).setPosition(new LatLong(latitude, longitude));
				layer.getCircles().get(jsonObj.getJSONObject("properties").getInt("index")).setRadius(jsonObj.getJSONObject("geometry").getDouble("radius"));
			} else if (jsonObj.getJSONObject("properties").get("type").equals("polyline") && jsonObj.getJSONObject("properties").getInt("index") < layer.getPolylines().size()) {
				...
				layer.getPolylines().get(jsonObj.getJSONObject("properties").getInt("index")).setPoints(points);
			} else if ((jsonObj.getJSONObject("properties").get("type").equals("feature") || jsonObj.getJSONObject("properties").get("type").equals("polygon") || jsonObj.getJSONObject("properties").get("type").equals("rectangle")) && jsonObj.getJSONObject("properties").getInt("index") < layer.getFeatures().size()) {
				layer.getFeatures().get(jsonObj.getJSONObject("properties").getInt("index")).setGeometry(jsonObj.getJSONObject("geometry").toString());
			}
		}
	}
	...
	public void delete(AjaxBehaviorEvent event) {
		...
		if (jsonObj.getJSONObject("properties").getInt("index") >= 0) {
			if (jsonObj.getJSONObject("properties").get("type").equals("marker") && jsonObj.getJSONObject("properties").getInt("index") < layer.getMarkers().size()) {
				layer.getMarkers().remove(jsonObj.getJSONObject("properties").getInt("index"));
			} else if (jsonObj.getJSONObject("properties").get("type").equals("circle") && jsonObj.getJSONObject("properties").getInt("index") < layer.getCircles().size()) {
				layer.getCircles().remove(jsonObj.getJSONObject("properties").getInt("index"));
			} else if (jsonObj.getJSONObject("properties").get("type").equals("polyline") && jsonObj.getJSONObject("properties").getInt("index") < layer.getPolylines().size()) {
				layer.getPolylines().remove(jsonObj.getJSONObject("properties").getInt("index"));
			} else if ((jsonObj.getJSONObject("properties").get("type").equals("feature") || jsonObj.getJSONObject("properties").get("type").equals("polygon") || jsonObj.getJSONObject("properties").get("type").equals("rectangle")) && jsonObj.getJSONObject("properties").getInt("index") < layer.getFeatures().size()) {
				layer.getFeatures().remove(jsonObj.getJSONObject("properties").getInt("index"));
			}
		}
	}
